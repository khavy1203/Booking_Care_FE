      ...
      fetch("https://provinces.open-api.vn/api/d", {
        ...
        .then((actualData) => {
          ...
          let lstDistrictOfProvince = actualData.filter(
            (item) => item.province_code === +this.state.selectedProvince
          );
      ...
      fetch("https://provinces.open-api.vn/api/w", {
        ...
        .then((actualData) => {
          ...
          let lstWardOfDistrict = actualData.filter(
            (item) => item.district_code === +this.state.selectedDistrict
          );
          ...
          <div className="form-contact">
            ...
            <div class="form-group col-4 address">
              ...
              <select
                ...
                onChange={(event) =>
                  this.handleOnchangeProvince(event.target.value)
                }
              >
            ...
            <div class="form-group col-4 address">
              ...
              <select
                ...
                onChange={(event) =>
                  this.handleOnchangeDistrict(event.target.value)
                }
              >
            ...
            <div class="form-group col-4 address">
              ...
              <select
                ...
                onChange={(event) =>
                  this.handleOnchangeWard(event.target.value)
                }
              >
            ...
            <div class="form-group col-6 file-img">
              <label for="exampleFormControlFile4" className="noice-dowload">
                File nén đính kèm (hình ảnh giấy chứng nhận hoạt động của phòng
                khám và danh sách bác sĩ, chứng nhận bác sĩ)
              </label>
              <input
                className={
