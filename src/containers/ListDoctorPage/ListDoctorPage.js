                                            ...
                                            <div className="ClinicDetail_address__3iTvZ">
                                                {
                                                    ...
                                                    lstDistrict &&
                                                    lstWard &&
                                                    `${inforClinic.addressVI} - ${lstWard[inforClinic.wardId]} - ${lstDistrict[inforClinic.districtId]} -  ${lstProvince[inforClinic.provinceId]}`
                                                }
                                            </div>
                                        </div>
                                    </div>
                                    <div className="ClinicDetail_bottom__1ocVm">
                                        ...
                                        <div className="ClinicDetail_list_item__3Xig4">
                                            ...
                                            <div className="ClinicDetail_text__3G2ed">
                                                {inforClinic.timework ? inforClinic.timework : `Từ thứ hai đến thứ bảy: từ 04h00 đến 19h00. Chủ nhật: từ 04h00
                                                đến 12h00.`}
                            ...
                            <div className="ClinicDetail_right_content__L_34K">
                                ...
                                <form className="Feedback_Feedback__17vAI ClinicDetail_block_item__3B88u">
                                    ...
                                    <div className="Feedback_text__2XSC4 mb-3 description-clinic" >
                                        {ReactHtmlParser(inforClinic.descriptionHTML_VI ? inforClinic.descriptionHTML_VI : "Mô tả phòng khám")}
                                    </div>
                                    ...
                                    <div className="Feedback_sub_title__2FcoY">
                                        Ý kiến đóng góp của bạn giúp chúng tôi cải thiện và nâng cao chất
                                    ...
                                    <div className="Feedback_button__1gtfE">
                                        <button type="submit" className="Feedback_btn_button__194m-">
                                            Gửi
                                        </button>
                                    </div>
                                </form>
