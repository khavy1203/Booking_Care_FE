...
class ProfileUser extends Component {
    ...
    fetchCookigetUserAccount = async () => {
        ...
        if (this.state.userData && this.state.userData.Clinic) {
            this.setState({ addressClinic: this.state.addressClinic + userData['Clinic']['addressVI'] })
    ...
    fetchProvince = async (code) => {
        fetch(`https://provinces.open-api.vn/api/p/${code}`, {
            ...
            .then((actualData) => {
                ...
                this.setState({ addressClinic: this.state.addressClinic + " - " + actualData.name })
            })
            .catch((err) => {
    ...
    updateUser = async () => {
        ...
        console.log("check valinput >>>", check, "check userDataUpdate>>> ", this.state.userData)
        if (check) {
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <div className="d-flex flex-column align-items-center text-center">
                                            <img
                                                src={userData && userData.image ? userData.image : "https://bootdey.com/img/Content/avatar/avatar7.png"}
                                                alt="Admin"
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-sm-9 text-secondary">
                                                            <input
                                                                className="form-control"
                                                                type="text"
                                                                value={userData && userData['Clinic'] ? userData['Specialty']['nameVI'] : ""}
                                                                onChange={(event) => {
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-sm-9 text-secondary">
                                                            <input
                                                                className="form-control"
                                                                type="text"
                                                                value={userData && userData['Clinic'] ? userData['Clinic']['nameVI'] : ""}
                                                                readOnly />
                                                        </div>
                                                    </div>
                                                </>
