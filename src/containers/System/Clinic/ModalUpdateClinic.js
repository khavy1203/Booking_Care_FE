...
class ModalUpdateClinic extends Component {
        ...
        fetch('https://provinces.open-api.vn/api/d', {
            ...
            .then((actualData) => {
                ...
                let lstDistrictOfProvince = actualData.filter((item) =>
                    item.province_code === +this.state.clinicData.provinceId
                )
        ...
        fetch('https://provinces.open-api.vn/api/w', {
            ...
            .then((actualData) => {
                ...
                let lstWardOfDistrict = actualData.filter((item) =>
                    item.district_code === +this.state.clinicData.districtId
                )
    ...
    checkValidateInput = () => {
        ...
        let array = ["nameVI", "addressVI", "nameEN", "addressEN", "provinceId", "districtId", "wardId"];
    ...
    handleUpdateClinic = async () => {
        ...
        console.log("kiểm tra check trong update clinic ", check, this.state.validInput);
        if (check) {
                    ...
                    <div className="container row content-body" >
                        <div className="add-new-specialty row">
                            ...
                            <div className="form-group col-4 address">
                                <label htmlFor="exampleFormControlSelect1">Tỉnh/Thành Phố</label>
                                <select
                                    className={
                            ...
                            <div className="col-12 row form-group mt-3">
                                ...
                                <div className="col-6 select-province">
                                    ...
                                    <div className="img-avatar">
                                        < img src={clinicData.image ? clinicData.image : 'https://image.shutterstock.com/z/stock-vector-drawings-design-house-no-color-334341113.jpg'} />
                                    </div>
                                </div>
