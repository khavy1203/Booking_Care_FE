...
class ModalUser extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (prevProps.action !== this.props.action || prevProps.dataModalUpdate !== this.props.dataModalUpdate) {//điều kiện update khi action thay đổi hoặc dữ liệu đổ vào modalupadate thay đổi
      if (this.props.action === "UPDATE") {//action cho update
        this.setState({
          userData: {
