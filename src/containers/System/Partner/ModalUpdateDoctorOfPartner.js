            ...
            >
                ...
                <Modal.Body>
                        ...
                        <div className="info-top row">
                            ...
                            <div className="col-6 form-group row">
                                <div class="form-group col-8 ">
                                    <label for="exampleFormControlFile4" className="noice-dowload">File nén đính kèm (tài liệu và thông tin bác sĩ)</label>
                                    <input
                                        className={
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <a target="_blank" href={this.state.doctorData ? this.state.doctorData.linkfile : "#"} >{this.state.doctorData && this.state.doctorData.linkfile ? " Bấm để lấy file" : " Chưa cập nhật link file"}</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-12 col-sm-6 form-groupId mt-3">
                        ...
                        >
                            <option value="">Vui lòng chọn trạng thái hoạt động của bác sĩ</option>
