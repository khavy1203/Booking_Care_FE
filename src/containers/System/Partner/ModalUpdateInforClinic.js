                        ...
                        <div className="add-new-specialty row">
                            <div className="col-12 form-group row">
                                <div class="form-group col-8 ">
                                    <label for="exampleFormControlFile4" className="noice-dowload">Hình ảnh trên Panel của Phòng Khám</label>
                                    <input
                                        className={
                                ...
                                <div>
                                    < img src={this.state.clinicData ? this.state.clinicData.image : 'https://image.shutterstock.com/z/stock-vector-drawings-design-house-no-color-334341113.jpg'} width={100} height={100} />
                                </div>
                            </div>
                            ...
                            <div className="col-12  mt-3 form-group">
                                <label className="col-12">Mô tả thời gian làm việc :
                                    <textarea
                                        value={this.state.clinicData?.timework}
                                        placeholder={"Vui lòng nhập một cách khái quát về thời gian làm việc..."}
