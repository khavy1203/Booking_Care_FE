...
class ModalUpdateSpecialty extends Component {
    constructor(props) {
        super(props);
        this.state = {
            specialtyData: {},
    ...
    handleCreateNewSpecialty = async () => {
        ...
        if (check) {
            ...
            let res = await updateCurrentSpecialty(this.state.specialtyData)
            if (res && +res.EC === 0) {
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalUpdateSpecialty);